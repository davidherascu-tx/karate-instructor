  ...
  return (
    <div className={`w-full bg-white min-h-screen pt-28 md:pt-[200px] pb-32 ${montserrat.className}`}>
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        {/* Intro Bereich - Mit deinen exakten Abständen */}
        ...
        {/* Kontrastreiches, klares Formular */}
        <div className="max-w-4xl border-t border-zinc-200 pt-12 md:pt-16">
          <form className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <input 
                  ...
                  className="w-full bg-zinc-100 border border-zinc-200 rounded-xl px-6 py-4 outline-none focus:border-red-600 focus:bg-white transition-colors text-zinc-900 font-medium placeholder:text-zinc-400"
                />
              </div>
            ...
            <div className="flex flex-col space-y-2">
              ...
              <select className="w-full bg-zinc-100 border border-zinc-200 rounded-xl px-6 py-4 outline-none focus:border-red-600 focus:bg-white transition-colors text-zinc-900 font-medium appearance-none cursor-pointer">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <textarea 
                ...
                className="w-full bg-zinc-100 border border-zinc-200 rounded-xl px-6 py-4 outline-none focus:border-red-600 focus:bg-white transition-colors text-zinc-900 font-medium placeholder:text-zinc-400 resize-none"
              ></textarea>
            </div>
            ...
            <div className="pt-4">
              <button 
                type="submit"
                className="w-full md:w-auto bg-zinc-900 text-white font-bold px-12 py-5 uppercase tracking-[0.2em] text-sm hover:bg-red-600 transition-all duration-300 rounded-xl shadow-md"
              >
                Nachricht senden
              </button>
            </div>
