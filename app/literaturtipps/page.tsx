    ...
    <div className={`w-full bg-white min-h-screen pt-[200px] pb-32 ${montserrat.className}`}>
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="max-w-4xl mb-16 text-left">
          <p className="text-red-600 font-bold tracking-[0.4em] uppercase text-xs mb-4">// Empfehlungen</p>
          <h1 className="text-5xl md:text-7xl font-black text-zinc-900 uppercase tracking-tighter leading-[0.85] mb-8">
            Literaturtipps
          </h1>
